            ...
            <div class="page-content">
                <div class="side-bar">
                    <ul>
                        ...
                        <li class="side-bar-menu" id="btn">
                            <a href="/add_teaching_material"> Добавить учебный материал</a>
                        </li>
                        <li class="side-bar-menu" id="btn">
                            <a href="/add_scientific_material"> Добавить публикацию</a>
                        </li>
                        <? if ($current_user_data['is_admin']): ?>
                        <li class="side-bar-menu" id="btn">
                            <a href="/create_user"> Создать нового пользователя</a>
                        </li>
                        <? endif ?>
                    </ul>
                </div>
